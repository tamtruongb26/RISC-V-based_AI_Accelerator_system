...
proc update_PARAM_VALUE.SA_N { PARAM_VALUE.SA_N } {
	# Procedure called to update SA_N when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SA_N { PARAM_VALUE.SA_N } {
	# Procedure called to validate SA_N
	return true
}
...
proc update_MODELPARAM_VALUE.SA_N { MODELPARAM_VALUE.SA_N PARAM_VALUE.SA_N } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SA_N}] ${MODELPARAM_VALUE.SA_N}
}
