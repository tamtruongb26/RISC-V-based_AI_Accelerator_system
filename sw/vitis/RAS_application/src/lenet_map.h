...
#define LENET_DDR_REL_GOLDEN_OFF   (LENET_DDR_REL_OFF + 0x00u)
#define LENET_DDR_REL_NOHARDEN_OFF (LENET_DDR_REL_OFF + 0x04u)
#define LENET_DDR_REL_ECC_OFF      (LENET_DDR_REL_OFF + 0x08u)
#define LENET_DDR_REL_ECC_CNT_OFF  (LENET_DDR_REL_OFF + 0x0Cu)
#define LENET_DDR_REL_TMR_OFF      (LENET_DDR_REL_OFF + 0x10u)
#define LENET_DDR_REL_TMR_CNT_OFF  (LENET_DDR_REL_OFF + 0x14u)
